...
public class CircularQueue<T> {
    ...
    public static void main(String[] args) throws QueueOverflowException, QueueUnderflowException{
        ...
        System.out.println("CircularQueue full?: " + queue.isFull());
        System.out.println("CircularQueue empty?: " + queue.isEmpty());
        ...
        System.out.println("CircularQueue peek: " + queue.peek());
        ...
        try {
            ...
            System.out.println("CircularQueue is full! No room available.");
        }
        ...
        try {
            ...
            System.out.println("CircularQueue is empty! No elements available.");
        }
